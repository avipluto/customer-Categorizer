...
class CustomerClusterEstimator:
    ...
    def save_model(self,from_file,remove:bool=False)->None:
        ...
        try:
            ...
            # FIX: previously "raise (e, sys)" tried to raise a tuple, which
            # is invalid in Python (exceptions must derive from BaseException).
            # That masked the real underlying upload error. Now raises a
            # proper CustomerException so the actual cause is visible.

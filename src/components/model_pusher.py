...
class ModelPusher:
    """
    Uploads the trained model to cloud storage (Backblaze B2, S3-compatible)
    via SimpleStorageService / CustomerClusterEstimator. The endpoint used
    is controlled by AWS_S3_ENDPOINT_URL in .env, wired up in
